...
public static class BotEndpoints
{
    public static void MapBotEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        {
            op.Parameters?[0].Description = "The number of games to play.";
            op.Parameters?[1].Description = "The delay between the games (seconds).";
            op.Parameters?[2].Description = "The think time between game moves (seconds).";
